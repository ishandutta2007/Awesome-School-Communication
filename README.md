...
| ---------------------------------------------------------------------------------------------------------------------------- | ----------------------------- | --------------------------------------------- |
| [SchoolMessenger](https://www.schoolmessenger.com/)                                                                          | K-12 mass communication       | Emergency + mass notifications                |
| [Finalsite Messages](https://www.finalsite.com/)                                                                             | School communications         | Websites + messaging + engagement             |
| [ParentSquare](https://www.parentsquare.com/)                                                                                | Family engagement             | Two-way communication + mass notifications    |
| [Apptegy Thrillshare](https://www.apptegy.com/)                                                                              | District communication        | Website + app + mass communication            |
| [Blackboard Mass Notifications](https://www.blackboard.com/teaching-learning/communication-collaboration/mass-notifications) | Emergency/mass notification   | Alerts + institutional messaging              |
| [Remind](https://www.remind.com/)                                                                                            | Teacher/family messaging      | Simple two-way school-home messaging          |
| [Edlio](https://www.edlio.com/)                                                                                              | School communications         | Website + CMS + mobile communication          |
| [SchoolStatus](https://www.schoolstatus.com/)                                                                                | Family engagement             | Data-driven communication                     |
| [Smore](https://www.smore.com/)                                                                                              | School newsletters            | Newsletter creation + distribution            |
| [Konstella](https://www.konstella.com/)                                                                                      | Parent/school community       | School-community communication                |
| [TalkingPoints](https://talkingpts.org/)                                                                                     | Family engagement             | Multilingual two-way communication            |
| [ClassDojo](https://www.classdojo.com/)                                                                                      | Family engagement             | Teacher-parent communication                  |
| [Bloomz](https://www.bloomz.com/)                                                                                            | School communication          | Messaging + announcements + parent engagement |
| [ParentSquare](https://www.parentsquare.com/)                                                                                | Family engagement             | District-wide communication                   |
| [SchoolStatus Connect](https://www.schoolstatus.com/products/connect-family-school-partnerships)                             | Family engagement             | Messaging + mass notifications + newsletters  |
| [Blackboard](https://www.anthology.com/products/teaching-and-learning/learning-effectiveness/blackboard)                     | Education platform            | Institutional communication ecosystem         |
| [PowerSchool](https://www.powerschool.com/)                                                                                  | Education platform            | SIS + family communication ecosystem          |
| [Finalsite](https://www.finalsite.com/)                                                                                      | K-12 digital platform         | Websites + communications                     |
| [SchoolInfoApp](https://www.schoolinfoapp.com/)                                                                              | School communication          | Mobile app + notifications                    |
| [TeacherEase](https://www.teacherease.com/)                                                                                  | School communication          | Parent/teacher communication                  |
| [Campus Suite](https://www.campussuite.com/)                                                                                 | School websites/communication | Websites + mobile communication               |
